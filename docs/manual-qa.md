...
Use only `tests/fixtures/computer-use/course-browser.html` in a temporary dedicated browser profile. Never use a student's normal browser profile or personal screens.
